...
f1 = tk.Label(window, text="FIRST NAME", bg='#6449C6',
              fg='white', padx=10, pady=15)
f1.place(x=5, y=0)

f1t = tk.Text(window, height=0.8, width=12)
f1t.place(x=150, y=12)

maxchar1 = tk.Label(window, text="(max 30 characters a-z and A-Z)",
                    bg='#6449C6', fg='white', font=("Arial", 8))
...
maxchar2 = tk.Label(window, text="(max 30 characters a-z and A-Z)",
                    bg='#6449C6', fg='white', font=("Arial", 8))
...
l1 = tk.Label(window, text="MOBILE NUMBER",
              bg='#6449C6', fg='white', padx=10, pady=10)
l1.place(x=5, y=150)

l1t = tk.Text(window, height=0.8, width=18)
l1t.place(x=150, y=160)

maxchar3 = tk.Label(window, text="(10 digit number)",
                    bg='#6449C6', fg='white', font=("Arial", 8), padx=-100)
maxchar3.place(x=250, y=160)

l1 = tk.Label(window, text="GENDER", bg='#6449C6',
              fg='white', padx=10, pady=10)
l1.place(x=5, y=190)

maxchar3 = tk.Label(window, text="Male", bg='#6449C6',
                    fg='white', font=("Arial", 8))
maxchar3.place(x=150, y=200)

tk.Radiobutton(window, value=1, bg='#6449C6').place(x=185, y=200)

maxchar3 = tk.Label(window, text="Female", bg='#6449C6',
                    fg='white', font=("Arial", 8))
maxchar3.place(x=225, y=200)

tk.Radiobutton(window, value=2, bg='#6449C6').place(x=270, y=200)

l1 = tk.Label(window, text="ADDRESS", bg='#6449C6',
              fg='white', padx=10, pady=15)
l1.place(x=5, y=225)
...
f1 = tk.Label(window, text="PINCODE", bg='#6449C6',
              fg='white', padx=10, pady=15)
f1.place(x=5, y=350)
...
maxchar1 = tk.Label(window, text="(6 digit number)",
                    bg='#6449C6', fg='white', font=("Arial", 8))
...
f1 = tk.Label(window, text="COUNTRY", bg='#6449C6',
              fg='white', padx=10, pady=15)
f1.place(x=5, y=428)
...
f1 = tk.Label(window, text="HOBBIES", bg='#6449C6',
              fg='white', padx=10, pady=15)
f1.place(x=5, y=470)

maxchar3 = tk.Label(window, text="Drawing", bg='#6449C6',
                    fg='white', font=("Arial", 8))
...
maxchar3 = tk.Label(window, text="Singing", bg='#6449C6',
                    fg='white', font=("Arial", 8))
...
maxchar3 = tk.Label(window, text="Dancing", bg='#6449C6',
                    fg='white', font=("Arial", 8))
...
maxchar3 = tk.Label(window, text="Others", bg='#6449C6',
                    fg='white', font=("Arial", 8))
...
f1 = tk.Label(window, text="QUALIFICATION",
              bg='#6449C6', fg='white', padx=10, pady=15)
f1.place(x=5, y=532)

maxchar3 = tk.Label(window, text="Sl.No.\tExamination\tBoard\t\tPercentage\tYear of passing",
                    bg='#6449C6', fg='white', font=("Arial", 8))
